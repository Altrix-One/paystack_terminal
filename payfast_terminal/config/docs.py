...
source_link = "https://github.com/ajakaiye33/paystack_terminal.git"
headline = "Payfast Terminal Integration"
sub_heading = "Process payments via Payfast Terminal"

def get_context(context):
	context.brand_html = "Payfast Terminal"
